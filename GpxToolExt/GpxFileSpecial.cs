...
namespace GpxTool {
   ...
   class GpxFileSpecial : GpxFile {
      ...
      /// <param name="outputstream">wird verwendet, wenn keine Datei angegeben ist</param>
      public void SaveHeight(string file, Stream outputstream) {
         Console.Error.WriteLine("speichere Höhenprofil in {0} ...", file);
         double length = 0;
         using (System.IO.StreamWriter stream = !string.IsNullOrEmpty(file) ?
